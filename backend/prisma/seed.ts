...
async function main() {
  ...
  const lessons = [
    ...
    { id: 'l-001', courseId: 'c-001', title: "Kompyuter nima? Asosiy qismlar", duration: '10 daq', type: 'video', order: 1, xpReward: 10, videoUrl: 'https://www.youtube.com/watch?v=jWP7FTVJSeI' },
    { id: 'l-002', courseId: 'c-001', title: "Operatsion tizim va ish stoli", duration: '12 daq', type: 'video', order: 2, xpReward: 10, videoUrl: 'https://www.youtube.com/watch?v=thHwfJCSHOc' },
    { id: 'l-003', courseId: 'c-001', title: "Fayllar va papkalar bilan ishlash", duration: '14 daq', type: 'video', order: 3, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=uq6S0o-V5f4' },
    { id: 'l-004', courseId: 'c-001', title: "Klaviatura va sichqoncha ko'nikmalari", duration: '10 daq', type: 'video', order: 4, xpReward: 10, videoUrl: 'https://www.youtube.com/watch?v=EP6DrHZfSL8' },
    { id: 'l-005', courseId: 'c-001', title: 'Kompyuter asoslari testi', duration: '10 daq', type: 'quiz', order: 5, xpReward: 30, videoUrl: null },
    { id: 'l-006', courseId: 'c-001', title: "Printerlar va tashqi qurilmalar", duration: '12 daq', type: 'video', order: 6, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=9kHmFNm2kuA' },
    // c-002: Ofis Dasturlari
    { id: 'l-011', courseId: 'c-002', title: "MS Word: Hujjat yaratish va formatlash", duration: '14 daq', type: 'video', order: 1, xpReward: 10, videoUrl: 'https://www.youtube.com/watch?v=phxtp3FA52U' },
    { id: 'l-012', courseId: 'c-002', title: "MS Word: Jadval va rasmlar qo'shish", duration: '14 daq', type: 'video', order: 2, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=DcE1bRTIvog' },
    { id: 'l-013', courseId: 'c-002', title: "MS Excel: Elektron jadval asoslari", duration: '16 daq', type: 'video', order: 3, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=wLKKeAzVy58' },
    { id: 'l-014', courseId: 'c-002', title: "MS Excel: Formulalar va funksiyalar", duration: '18 daq', type: 'video', order: 4, xpReward: 20, videoUrl: 'https://www.youtube.com/watch?v=DC3n3PKfa6U' },
    { id: 'l-015', courseId: 'c-002', title: 'Ofis dasturlari testi', duration: '10 daq', type: 'quiz', order: 5, xpReward: 30, videoUrl: null },
    { id: 'l-016', courseId: 'c-002', title: "PowerPoint: Taqdimot yaratish", duration: '14 daq', type: 'video', order: 6, xpReward: 20, videoUrl: 'https://www.youtube.com/watch?v=E5AzelysLQc' },
    // c-003: Algoritmlar va Dasturlash
    { id: 'l-017', courseId: 'c-003', title: "Algoritm nima? Kundalik misollar", duration: '10 daq', type: 'video', order: 1, xpReward: 10, videoUrl: 'https://www.youtube.com/watch?v=JZZbZVzcFN4' },
    { id: 'l-018', courseId: 'c-003', title: "Blok-sxema tuzish qoidalari", duration: '12 daq', type: 'video', order: 2, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=oPVp3OJhgH0' },
    { id: 'l-019', courseId: 'c-003', title: "Python kirish: o'rnatish va birinchi dastur", duration: '15 daq', type: 'video', order: 3, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=4g2MCEQxZ7c' },
    { id: 'l-020', courseId: 'c-003', title: "Python: o'zgaruvchilar va ma'lumot turlari", duration: '18 daq', type: 'video', order: 4, xpReward: 20, videoUrl: 'https://www.youtube.com/watch?v=fU-3YmGTWyg' },
    { id: 'l-021', courseId: 'c-003', title: 'Algoritmlar testi', duration: '10 daq', type: 'quiz', order: 5, xpReward: 30, videoUrl: null },
    { id: 'l-022', courseId: 'c-003', title: "Python: shartli operatorlar (if/else)", duration: '16 daq', type: 'video', order: 6, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=cQT33yu9pY8' },
    { id: 'l-023', courseId: 'c-003', title: "Python: sikllar (for, while)", duration: '18 daq', type: 'video', order: 7, xpReward: 20, videoUrl: 'https://www.youtube.com/watch?v=DZwmZ8Usvnk' },
    { id: 'l-024', courseId: 'c-003', title: "Python: funksiyalar", duration: '20 daq', type: 'video', order: 8, xpReward: 25, videoUrl: 'https://www.youtube.com/watch?v=9Os0o3wzS_I' },
    // c-004: Internet va Axborot Xavfsizligi
    { id: 'l-025', courseId: 'c-004', title: "Internet qanday ishlaydi?", duration: '12 daq', type: 'video', order: 1, xpReward: 10, videoUrl: 'https://www.youtube.com/watch?v=2wg__cJWub8' },
    { id: 'l-026', courseId: 'c-004', title: "Brauzer va qidiruv tizimlari", duration: '10 daq', type: 'video', order: 2, xpReward: 10, videoUrl: 'https://www.youtube.com/watch?v=9kHmFNm2kuA' },
    { id: 'l-027', courseId: 'c-004', title: "Elektron pochta (e-mail) bilan ishlash", duration: '12 daq', type: 'video', order: 3, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=thHwfJCSHOc' },
    { id: 'l-028', courseId: 'c-004', title: "Axborot xavfsizligi: parollar va tahdidlar", duration: '14 daq', type: 'video', order: 4, xpReward: 20, videoUrl: 'https://www.youtube.com/watch?v=EP6DrHZfSL8' },
    ...
    { id: 'l-030', courseId: 'c-005', title: "Ma'lumotlar bazasi nima?", duration: '10 daq', type: 'video', order: 1, xpReward: 10, videoUrl: 'https://www.youtube.com/watch?v=CrXUtjChEnA' },
    { id: 'l-031', courseId: 'c-005', title: "Jadval, ustun va qatorlar tushunchasi", duration: '12 daq', type: 'video', order: 2, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=1ztYVUetfr0' },
    { id: 'l-032', courseId: 'c-005', title: "SQL: SELECT so'rovi va shartlar", duration: '16 daq', type: 'video', order: 3, xpReward: 20, videoUrl: 'https://www.youtube.com/watch?v=wLKKeAzVy58' },
    { id: 'l-033', courseId: 'c-005', title: "SQL: Ma'lumot qo'shish va o'chirish", duration: '14 daq', type: 'video', order: 4, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=DC3n3PKfa6U' },
    ...
    { id: 'l-035', courseId: 'c-006', title: "HTML nima? Birinchi sahifa", duration: '12 daq', type: 'video', order: 1, xpReward: 10, videoUrl: 'https://www.youtube.com/watch?v=h2ucBIYlS1Q' },
    { id: 'l-036', courseId: 'c-006', title: "HTML: teglar va atributlar", duration: '14 daq', type: 'video', order: 2, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=qMfC33SzVxQ' },
    { id: 'l-037', courseId: 'c-006', title: "CSS: selektorlar va xossalar", duration: '16 daq', type: 'video', order: 3, xpReward: 15, videoUrl: 'https://www.youtube.com/watch?v=phxtp3FA52U' },
