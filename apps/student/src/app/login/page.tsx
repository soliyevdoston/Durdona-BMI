  ...
  return (
    <div className="min-h-screen bg-app flex items-center justify-center px-4">
      <div className="w-full max-w-md animate-slide-up">
        ...
        <button type="button" onClick={() => { setEmail('durdona@student.uz'); setPassword('1234') }} className="w-full text-center text-xs text-base-700 mt-6 hover:text-base-400 transition-colors">
          Demo: <code className="code-font text-base-500">durdona@student.uz / 1234</code>
        </button>
      </div>
    </div>
  )
