...
const NAV_ITEMS = [
  { href: '/teacher/dashboard', icon: LayoutDashboard, label: 'Bosh sahifa' },
  { href: '/teacher/courses', icon: GraduationCap, label: 'Mening Kurslarim' },
  { href: '/teacher/create-course', icon: Plus, label: 'Kurs yaratish' },
  { href: '/teacher/students', icon: Users, label: 'Talabalar' },
  { href: '/teacher/assignments', icon: ClipboardList, label: 'Topshiriqlar' },
  { href: '/teacher/analytics', icon: BarChart3, label: 'Tahlil' },
  { href: '/teacher/live', icon: Video, label: 'Jonli Dars' },
]
