    ...
    <div className="max-w-7xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <div className="card p-5 lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/teacher/students" className="text-xs text-sky-400 hover:text-sky-300 flex items-center gap-1">
      ...
      <div className="card p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/teacher/courses" className="text-xs text-sky-400 hover:text-sky-300 flex items-center gap-1">
            Barchasi <ChevronRight className="w-3 h-3" />
          </Link>
        </div>
