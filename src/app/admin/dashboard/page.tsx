      ...
      <div className="grid lg:grid-cols-3 gap-5">
        <div className="card p-5 lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/logs" className="text-xs text-emerald-400 hover:text-emerald-300 flex items-center gap-1">
        ...
        <div className="space-y-5">
          ...
          <div className="card p-5">
            ...
            <div className="space-y-2">
              {[
                { label: 'Foydalanuvchilarni boshqarish', icon: Users, href: '/admin/users' },
                { label: 'Tizim sozlamalari', icon: Server, href: '/admin/system' },
                { label: 'Xavfsizlik auditi', icon: Shield, href: '/admin/security' },
              ].map(a => (
