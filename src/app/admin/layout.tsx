...
const NAV_ITEMS = [
  { href: '/admin/dashboard', icon: LayoutDashboard, label: 'Bosh sahifa' },
  { href: '/admin/users', icon: Users, label: 'Foydalanuvchilar' },
  { href: '/admin/courses', icon: BookOpen, label: 'Kurslar' },
  { href: '/admin/analytics', icon: BarChart3, label: 'Tahlil' },
  { href: '/admin/system', icon: Server, label: 'Tizim' },
  { href: '/admin/logs', icon: FileText, label: 'Loglar' },
  { href: '/admin/security', icon: Shield, label: 'Xavfsizlik' },
