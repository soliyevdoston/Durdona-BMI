...
const NAV_ITEMS = [
  ...
  { href: '/student/courses', icon: GraduationCap, label: 'Kurslar' },
  { href: '/student/playground', icon: Code2, label: 'Kod Muhiti' },
  { href: '/student/assignments', icon: ClipboardList, label: 'Topshiriqlar' },
  { href: '/student/portfolio', icon: Award, label: 'Portfolio' },
  { href: '/student/ai', icon: Brain, label: 'AI Yordamchi' },
]
